              ...
              <div class="span3">
                ...
                <select class="facet facet-js" id="facet-js-0-1" name="facet-0-1" style="display: none" disabled="disabled">
                  ...
                  <g:each in="${facetSearchfields}">
                    ...
                    <g:elseif test="${ it.name == 'signature' && it.searchType == textSearchType }">
                      <option value="${it.name}" selected data-inputid="value-0-1">
                        <g:message code="${languageTagPrefix}${it.name}" />
                      </option>
                    </g:elseif>
              ...
              <div class="span3">
                ...
                <select class="facet facet-js" id="facet-js-0-3" name="facet-0-3" style="display: none" disabled="disabled">
                  ...
                  <g:each in="${facetSearchfields}">
                    ...
                    <g:if test="${it.searchType == enumSearchType}">
                      <option value="${it.name}" data-inputid="${it.name}${facetNameSuffix}-0-3">
                        <g:message code="${languageTagPrefix}${it.name}" />
                      </option>
                    </g:if>

                    <g:elseif test="${ it.name == 'archieve_type' && it.searchType == textSearchType }">
                ...
                <select class="facet facet-simple" name="facet-0-3">
                  <g:each in="${facetSearchfields}">
                    <div>${ it.name }</div>
                    <g:if test="${ it.name == 'archieve_type' && it.searchType == textSearchType }">
                      <option value="${it.name}" selected>
                        <g:message code="${languageTagPrefix}${it.name}" />
                      </option>
                    </g:if>
