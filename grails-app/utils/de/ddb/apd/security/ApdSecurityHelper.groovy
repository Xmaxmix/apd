...
import de.ddb.apd.exception.InvalidUrlException;
 ...
 * @author hla
 */
class ApdSecurityHelper {

    private def log = LogFactory.getLog(this.class)

    /**
     * Cleans a ServletRequest from malicious code. The request object must be of type ApdRequestWrapper, because
     ...
     */
    void sanitizeRequest(ApdServletRequestWrapper request, HttpServletResponse response){
    ...
    private void sanitizeRequestUrl(ApdServletRequestWrapper request, HttpServletResponse response) {
     ...
     * @param request The wrapped request object
     */
    private void sanitizeRequestHeaders(ApdServletRequestWrapper request) {
     ...
     */
    private void sanitizeRequestParameters(ApdServletRequestWrapper request, XmlSlurper slurper){
     ...
     */
    private void sanitizeRequestCookies(ApdServletRequestWrapper request, XmlSlurper slurper){
